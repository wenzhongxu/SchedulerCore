...
namespace SchedulerCore.Host.Controllers
{
    ...
    public class SetingController : ControllerBase
    {
        ...
        [HttpPost]
        [NoLogin]
        public async Task<LoginInfoOutput> VerifyLoginInfo([FromBody] LoginInfoParamDto input)
        {
            ...
            {
                var defaultPassword = Common.ConfigurationManager.GetTryConfig("DefaultPassword");
